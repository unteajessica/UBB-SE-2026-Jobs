...
namespace Tests_and_Interviews.Helpers
{
    ...
    /// <summary>
    /// Converts a string value to a <see cref="Visibility"/> value for use in XAML bindings.
    /// </summary>
    public class StringToVisibilityConverter : IValueConverter
    {
        ...
        /// <returns><see cref="Visibility.Visible"/> if the value is a non-empty string; otherwise <see cref="Visibility.Collapsed"/>.</returns>
