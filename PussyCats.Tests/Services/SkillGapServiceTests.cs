...
public class SkillGapServiceTests
{
    ...
    {
        matchRepo.Seed(new Match { MatchId = 1, User = new User { UserId = 1 }, Job = new Job { JobId = 1 }, Status = MatchStatus.Applied });
    ...
    {
        matchRepo.Seed(new Match { MatchId = 1, User = new User { UserId = 1 }, Job = new Job { JobId = 10 }, Status = MatchStatus.Rejected });
